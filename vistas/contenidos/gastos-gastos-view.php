...
<div class="full-box page-header">
    <h3 class="text-left">
        <i class="fas fa-plus fa-fw"></i> &nbsp; LISTA DE GASTOS
    </h3>
...
<div class="container-fluid">
    <ul class="full-box list-unstyled page-nav-tabs">
        ...
        <li>
            <a class="active" href="<?php echo SERVERURL; ?>gastos-gastos/"><i class="far fa-calendar-alt"></i> &nbsp; GASTOS</a>
        </li>
        <li>
...
<div class="container-fluid">
    ...
    <?php 
        ...
        echo $ins_gasto->paginador_gasto_controlador($pagina[1],15,$_SESSION['privilegio_spm'],$pagina[0],"Aprobado","","");
    ?>                
</div>
