				...
				<div class="row">
					<div class="col-12 col-md-4">
						<div class="form-group">
							...
							<input type="text" pattern="[a-zA-Z0-9-]{1,45}" class="form-control" name="item_codigo_up" id="item_codigo" value="<?php echo $campos['item_codigo'] ?>" maxlength="45">
						</div>
					</div>
					...
					<div class="col-12 col-md-8">
						<div class="form-group">
							...
							<input type="text" pattern="[a-zA-ZáéíóúÁÉÍÓÚñÑ ]{1,40}" class="form-control" name="item_nombre_up" id="item_nombre" value="<?php echo $campos['item_nombre'] ?>" maxlength="140">
						</div>
					</div>
					...
					<div class="col-12 col-md-6">
						<div class="form-group">
							...
							<select class="form-control" name="item_tipo_up" id="item_tipo">
								<option value="Producto" <?php if ($campos['item_tipo']=="Producto") {
									echo 'selected=""';
								} ?> >Producto <?php if($campos['item_tipo']=="Producto"){ echo '(Actual)';} ?> </option>
								<option value="Servicio" <?php if ($campos['item_tipo']=="Servicio") {
									echo 'selected=""';
								} ?> >Servicio <?php if($campos['item_tipo']=="Servicio"){ echo '(Actual)';} ?> </option>
					...
					<div class="col-12 col-md-6">
						<div class="form-group">
							...
							<input type="num" pattern="[0-9]{1,9}" class="form-control" name="item_stock_up" id="item_stock" value="<?php echo $campos['item_stock'] ?>" maxlength="9">
						</div>
					</div>
					<div class="col-12 col-md-6">
						<div class="form-group">
							...
							<select class="form-control" name="item_estado_up" id="item_estado">
								<option value="Activo" <?php if ($campos['item_estado']=="Activo") {
									echo 'selected=""';
								} ?> >Activo <?php if($campos['item_estado']=="Activo"){ echo '(Actual)';} ?> </option>

								<option value="Inactivo" <?php if ($campos['item_estado']=="Inactivo") {
									echo 'selected=""';
								} ?> >Inactivo <?php if($campos['item_estado']=="Inactivo"){ echo '(Actual)';} ?> </option>
							</select>
						</div>
					</div>
					<div class="col-12 col-md-6">
						<div class="form-group">
							...
							<input type="text" pattern="[a-zA-Z0-9áéíóúÁÉÍÓÚñÑ().,#\- ]{1,190}" class="form-control" name="item_detalle_up" id="item_detalle"  value="<?php echo $campos['item_detalle'] ?>" maxlength="190">
						</div>
					</div>
				</div>
			</div>
