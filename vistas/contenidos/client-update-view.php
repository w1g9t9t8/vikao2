...
<div class="container-fluid">
	<ul class="full-box list-unstyled page-nav-tabs">
		<li>
			<a  href="<?php echo SERVERURL; ?>clientRegistrar/"><i class="fas fa-plus fa-fw"></i> &nbsp; AGREGAR CLIENTE</a>
		</li>
		<li>
		...
		<li>
			<a   href="<?php echo SERVERURL; ?>clientTop/"><i class="fas fa-medal"></i> &nbsp; TOP CLIENTES</a>
		</li>
	</ul>	
</div>
				...
				<div class="row">
					<div class="col-12 col-md-6">
						<div class="form-group">
							...
							<input type="text" pattern="[0-9]{8}" class="form-control" name="cliente_dni_up" value="<?php echo $campos['cliente_dni'] ?>" id="cliente_dni" maxlength="27">
						</div>
					</div>
					<div class="col-12 col-md-6">
						<div class="form-group">
							<label for="cliente_nombre" class="bmd-label-floating">Nombre</label>
							<input type="text" pattern="[a-zA-ZáéíóúÁÉÍÓÚñÑ ]{1,40}" class="form-control" name="cliente_nombre_up" id="cliente_nombre" value="<?php echo $campos['cliente_nombre'] ?>" maxlength="40">
						</div>
					</div>
					<div class="col-12 col-md-4">
						<div class="form-group">
							<label for="cliente_apellido" class="bmd-label-floating">Apellido</label>
							<input type="text" pattern="[a-zA-ZáéíóúÁÉÍÓÚñÑ ]{1,40}" class="form-control" name="cliente_apellido_up" id="cliente_apellido" value="<?php echo $campos['cliente_apellido'] ?>" maxlength="40">
						</div>
					</div>
					<div class="col-12 col-md-4">
						<div class="form-group">
							<label for="cliente_telefono" class="bmd-label-floating">Celular</label>
							<input type="text" pattern="[0-9]{9}" class="form-control" name="cliente_telefono_up" id="cliente_telefono" value="<?php echo $campos['cliente_telefono'] ?>" maxlength="20">
						</div>
					</div>
					<div class="col-12 col-md-4">
						<div class="form-group">
